...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_gkui7ui",
        "template_9vhlwpn", // First is a service token key
      ...
      >
        ...
        >
          ...
          <div className="flex justify-evenly">
            ...
            font-bold shadow-md shadow-btn_colors opacity-80 hover:opacity-100
            rounded-xl "
            >
            ...
            <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer opacity-80 hover:opacity-100"
            >
              <img
                src={github}
                alt={"github"}
